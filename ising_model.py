...
def main():
    ...
    ## uncomment the relationship of interest
...
## find the neighbours of the current spin to evaluate e_flip (the energy required to flip the spin)
...
## flip spins by comparing the energy change to the boltzmann factor
...
## uncomment the relationship of interest chose above
