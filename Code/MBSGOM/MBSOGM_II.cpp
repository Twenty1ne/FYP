...
implements the power-law distribution of GMC masses
implements the radial distribution of gas (GMC entities)
*/
...
void save_galaxy_history(const std::vector<std::string>& galaxy_history){
    ...
    std::ofstream outfile("MBSOGM_II_history.txt");
    if (!outfile.is_open()) {
    ...
    outfile.close();
    std::cout << "Data written to MBSOGM_II_history.txt\n";
}

// saves the mass component history for plotting
void save_mass_history(const std::vector<std::vector<unsigned long>>& galaxy_mass){
    std::cout << "Writing Mass History" << std::endl;
    std::ofstream outfile("MBSOGM_II_mass_history.txt");
    if(outfile.is_open()){
        ...
        outfile.close();
        std::cout << "Data written to MBSOGM_II_mass_history.txt" << std::endl;
    }
    else{
...
void save_correlation_history(const std::vector<std::string>& correlation_history){
    ...
    std::ofstream outfile("MBSOGM_II_correlations_history.txt");
    if (!outfile.is_open()) {
        std::cout << "Error opening file\n";
        return;
    }
    ...
    outfile.close();
    std::cout << "Data written to MBSOGM_II_correlations_history.txt\n";
}