...
def main():
    ...
    temperature = 2.25 ## choose a temperature to analyse. 2.25 is the critical temp
    ...
    ## tracks changes if they consecutively move in the same direction
    merged = []
    buffer = delta_M[0]
    ...
    merged.append(round(buffer, 3))
    merged = [abs(val) for val in merged]
